...
class Shadertoy(Gtk.GLArea, Widget):
    ...
    def shader_buffer(self) -> str: # type: ignore
        return self._shader_buffer

    @shader_buffer.setter # type: ignore
    ...
    def set_uniform(
        ...
        match type:
            ...
            case ShadertoyUniformType.TEXTURE:
                ...
                format = GL.GL_RGBA if value.get_has_alpha() else GL.GL_RGB # type: ignore
                ...
                GL.glTexImage2D(
                    ...
                    value.get_width(), # type: ignore
                    value.get_height(), # type: ignore
                    0,  # "border"
                    format,  # input format
                    GL.GL_UNSIGNED_BYTE,
                    value.get_pixels(), # type: ignore
                )
